...
//   // Function to get appointment date for sorting
...
//     }
//     return new Date(0); // Default date for appointments without date
//   };

//   // Function to sort appointments: pending first (by time), then others
...
//       // If both are pending, sort by time
...
//       // If neither is pending, sort by time
//       const dateA = getAppointmentDate(a);
//       const dateB = getAppointmentDate(b);
//       return dateA - dateB;
//     });
