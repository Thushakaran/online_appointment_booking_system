  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-[linear-gradient(to_right,#1e1e2f,#2a003f)] backdrop-blur-lg border-b border-gray-700 shadow-lg">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        >
          {/* Icon */}
          <FaCalendarCheck className="text-purple-400" size={30} />

          {/* Gradient Text (static, no animation) */}
          <span className="text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-lg">
            Appointment Booking
          </span>
        </Link>
        ...
        <div className="flex items-center gap-6">
          {token ? (
            <>
              ...
              {/* User menu */}
              <div className="flex items-center gap-2 ml-4 pl-4 border-l border-gray-500">
                <Link
                  to="/profile"
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg text-white transition-colors ${
